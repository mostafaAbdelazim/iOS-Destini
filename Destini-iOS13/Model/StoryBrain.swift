...
struct StoryBrain {
    ...
    mutating func subitChoice(_ choice: String) {
        let currentStory = stories[currentStoryIndex]
        currentStoryIndex = currentStory.choice1Text == choice ? currentStory.choice1Destination : currentStory.choice2Destination
    }
    ...
    func getStoryFirstChoice() -> String {
        return stories[currentStoryIndex].choice1Text
    }

    func getStorySecondChoice() -> String {
        return stories[currentStoryIndex].choice2Text
    }
}
